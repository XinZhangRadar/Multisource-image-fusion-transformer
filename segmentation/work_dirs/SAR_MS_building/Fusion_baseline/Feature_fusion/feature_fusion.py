...
log_level = 'INFO'
load_from = None
resume_from = '/share/home/zhangxin/mmsegmentation/work_dirs/SAR_MS_building/Fusion_baseline/Feature_fusion/latest.pth'
workflow = [('train', 1)]
...
work_dir = './work_dirs/SAR_MS_building/Fusion_baseline/Feature_fusion/'
gpu_ids = range(0, 1)
