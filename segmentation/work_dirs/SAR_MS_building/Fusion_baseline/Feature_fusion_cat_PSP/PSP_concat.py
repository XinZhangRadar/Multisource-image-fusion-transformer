...
model = dict(
    ...
    auxiliary_head=dict(
        type='MSF', in_index=3, input_dim=2048, fusion_style='concat'),
    train_cfg=dict(),
...
log_level = 'INFO'
load_from = None
resume_from = '/share/home/zhangxin/mmsegmentation/work_dirs/SAR_MS_building/Fusion_baseline/Feature_fusion_cat_PSP/latest.pth'
workflow = [('train', 1)]
...
work_dir = './work_dirs/SAR_MS_building/Fusion_baseline/Feature_fusion_cat_PSP/'
gpu_ids = range(0, 1)
