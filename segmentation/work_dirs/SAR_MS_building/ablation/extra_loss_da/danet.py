...
log_level = 'INFO'
load_from = None
resume_from = '/share/home/zhangxin/mmsegmentation/work_dirs/SAR_MS_building/ablation/extra_loss_da/iter_73600_67.87.pth'
workflow = [('train', 1)]
cudnn_benchmark = True
optimizer = dict(type='SGD', lr=0.01, momentum=0.9, weight_decay=0.0005)
optimizer_config = dict()
lr_config = dict(policy='poly', power=0.9, min_lr=0.0001, by_epoch=False)
runner = dict(type='IterBasedRunner', max_iters=85600)
checkpoint_config = dict(by_epoch=False, interval=400)
evaluation = dict(interval=400, metric='mIoU')
work_dir = '/share/home/zhangxin/mmsegmentation/work_dirs/SAR_MS_building/ablation/extra_loss_da/'
gpu_ids = range(0, 1)
