...
log_level = 'INFO'
load_from = None
resume_from = '/share/home/zhangxin/mmsegmentation/work_dirs/SAR_MS_building/ablation/extra_loss/iter_48400.pth'
workflow = [('train', 1)]
...
work_dir = './work_dirs/SAR_MS_building//ablation/extra_loss/'
gpu_ids = range(0, 1)
