...
log_level = 'INFO'
load_from = None
resume_from = '/home/zhangxin/mmsegmentation/work_dirs/SAR_MS_building/MsIFT/DANet/iter_42800.pth'
workflow = [('train', 1)]
...
work_dir = './work_dirs/SAR_MS_building/MsIFT/DANet/'
gpu_ids = range(0, 1)
